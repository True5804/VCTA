...
2. static.py :  Catch the images in "accident_frames". Draw the bounding box of the accident by connecting to API key of Roboflow in YOLOv5 model. Draw a red dot in the center of the bounding box as the accident dot.
3. run_height_then_midas.py : Calculate the distance between CCTV camera and the accident dot in the input video file. Store the output data into "accident_distances.json"
